...
ПРИМЕР ХОРОШЕГО ОТВЕТА (ориентируйся на этот стиль):
"""
**Созависимость** — это особый тип привязанности, при котором один партнёр эмоционально "растворяется" в другом, теряя собственные границы и идентичность.

Корни этого явления уходят в детство: человек не получил опыта безусловной любви — его принимали только когда он соответствовал ожиданиям. Так сформировалось убеждение "Я ценен только когда нужен другому", которое теперь бессознательно воспроизводится во взрослых отношениях...
"""
